...
public class StatementPrinter {
    ...
    public void setPlays(Map<String, Play> newPlays) {
        plays = newPlays;
    }
    ...
    private static String usd(int amountToFormat) {
        return NumberFormat.getCurrencyInstance(Locale.US).format(amountToFormat / Constants.PERCENT_FACTOR);
    }
